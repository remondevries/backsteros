export function groupItemsByAlphaLetter(items) {
    ...
    for (const entries of groups.values()) {
        entries.sort((a, b) => {
            ...
            if (lastCmp !== 0)
                return lastCmp;
            const aFirst = (a.firstName?.trim() || a.name || "").toLocaleLowerCase();
            const bFirst = (b.firstName?.trim() || b.name || "").toLocaleLowerCase();
