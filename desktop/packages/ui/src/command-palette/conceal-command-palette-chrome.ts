...
export function concealCommandPaletteChrome(): void {
...
export function revealCommandPaletteChrome(): void {
  if (typeof document === "undefined") return;
  ...
  for (const node of document.querySelectorAll(
    ".command-overlay, .command-dialog",
  )) {
 ...
 */
export function showInstantCommandOverlay(): void {
  if (typeof document === "undefined") return;
...
export function dismissInstantCommandOverlay(): void {
  if (typeof document === "undefined") return;
