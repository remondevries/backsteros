import { formatTaskDisplayId } from "../tasks/task-display-id.js";
import {
...
> = {
  ...
  "/spaces": { navId: "knowledge", badgeLabel: "Spaces" },
  "/knowledge": { navId: "knowledge", badgeLabel: "Spaces" },
  "/knowledge-v2": { navId: "knowledge", badgeLabel: "Spaces" },
  "/tasks": { navId: "tasks", badgeLabel: "Tasks" },
  "/calendar": { navId: "calendar", badgeLabel: "Agenda" },
  "/areas": { navId: "projects", badgeLabel: "Projects" },
  "/projects": { navId: "projects", badgeLabel: "Projects" },
  "/catalog": { navId: "catalog", badgeLabel: "Catalog" },
  "/development": { navId: "catalog", badgeLabel: "Catalog" },
  "/letters": { navId: "letters", badgeLabel: "Letters" },
  "/letters-v2": { navId: "letters", badgeLabel: "Letters" },
  "/social": { navId: "social", badgeLabel: "Network" },
