...
export type ProjectOverviewRowProject = {
  ...
  areaId?: string | null;
  /** Linked organization (Development console groups by this). */
...
export type ProjectOverviewRowProps = {
  ...
  /** When true, replace the status icon with the agent-working pulse. */
  ...
  return (
    <li
      className={[
        ...
        dragging ? "project-overview-row-item--dragging" : null,
      ]
        .filter(Boolean)
        .join(" ")}
      ...
      <div
        ...
        className={[
          ...
          canPointerReorder || canHtml5Drag
            ...
            : null,
          dragging ? "project-overview-row--dragging" : null,
        ]
          .filter(Boolean)
          .join(" ")}
