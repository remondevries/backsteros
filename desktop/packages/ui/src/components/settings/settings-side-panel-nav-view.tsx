...
import { SidebarChevronIcon } from "../shell/sidebar-nav-icons.js";
...
export function SettingsSidePanelNavView({
  ...
  return (
    ...
    >
      {/*
        Match ProductSidebar: reserve the titlebar / history-toolbar row so
        the Settings header sits on the same baseline as the logo + BacksterOS.
      */}
