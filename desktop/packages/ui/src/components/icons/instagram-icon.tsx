...
/**
 * Instagram brand mark (gradient glyph) for contact social accounts.
 * Gradient ids are scoped per instance so multiple icons can coexist.
 */
export function InstagramIcon({ size = 16, ...props }: InstagramIconProps) {
