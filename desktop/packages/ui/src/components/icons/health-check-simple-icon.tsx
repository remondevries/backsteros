...
export type HealthCheckSimpleIconProps = SVGProps<SVGSVGElement> & {
  size?: number | string;
};

/** Pencil mark for Health check → Simple (URL) option. */
export function HealthCheckSimpleIcon({
  size = 16,
  ...props
}: HealthCheckSimpleIconProps) {
  return (
    <svg
      width={size}
      height={size}
