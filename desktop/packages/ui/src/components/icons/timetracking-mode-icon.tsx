...
export type TimetrackingModeIconProps = SVGProps<SVGSVGElement> & {
  size?: number | string;
};

/** Filled stopwatch/check mark for Agenda → Timetracking mode toggle. */
export function TimetrackingModeIcon({
  size = 16,
  ...props
}: TimetrackingModeIconProps) {
  return (
    <svg
      width={size}
      height={size}
