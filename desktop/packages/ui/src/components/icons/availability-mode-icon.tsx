...
export type AvailabilityModeIconProps = SVGProps<SVGSVGElement> & {
  size?: number | string;
};

/** Calendar-with-plus mark for Agenda → Availability mode toggle. */
export function AvailabilityModeIcon({
  size = 16,
  ...props
}: AvailabilityModeIconProps) {
  return (
    <svg
      width={size}
      height={size}
