...
export type CloudflareIconProps = Omit<
  SVGProps<SVGSVGElement>,
  "width" | "height" | "viewBox"
> & {
  /** Logo height in CSS pixels (width follows the brand aspect ratio). */
  height?: number;
};
...
/**
 * Cloudflare brand mark (official lockup) for Catalog Domains connected badges.
 */
export function CloudflareIcon({ height = 12, ...props }: CloudflareIconProps) {
