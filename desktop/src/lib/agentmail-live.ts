...
/**
 * Inbox enable/live follows `visibleKeepAliveSurface`, not the router.
 * Email / compose stay on Outlet — only then do we read the window href.
 */
