...
function OrgScopedProjectsPage() {
  ...
  const { organizations, ready: workspaceReady } = useDesktopWorkspaceData();
    ...
    <>
      ...
      <Route element={<ShellLayout />}>
        ...
        <Route
          ...
          element={<ProjectsPage />}
        />
        <Route path="projects/:slug/files/*" element={<ProjectsPage />} />
        <Route path="projects/:slug/files" element={<ProjectsPage />} />
        <Route path="projects/:slug/commits/:sha" element={<ProjectsPage />} />
        <Route path="projects/:slug/commits" element={<ProjectsPage />} />
        <Route
          path="projects/:slug/pulls/:number"
          element={<ProjectsPage />}
        />
        <Route path="projects/:slug/pulls" element={<ProjectsPage />} />
