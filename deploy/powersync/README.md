...
`projects`, `tasks`, `documents`, `organizations`, `contacts`, `areas`, `letters`, `avatars`, `mentions`, `workspace_settings`, `bank_accounts`, `financial_categories`, `financial_goals`, `financial_recurrings`
