...
export type BacksterosHealthCheckIconProps = SVGProps<SVGSVGElement> & {
  size?: number | string;
};

/** Pulse / waveform mark — desktop `HealthCheckIcon`. */
export function BacksterosHealthCheckIcon({ size = 16, ...props }: BacksterosHealthCheckIconProps) {
  return (
    <svg
      width={size}
      height={size}
