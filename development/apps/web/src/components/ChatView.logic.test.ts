...
describe("agent browser close confirmation", () => {
  const surfaces = [
    { id: "browser:thread-A:one", kind: "preview", resourceId: "tab-1", ownerThreadId: "thread-A" },
    { id: "browser:thread-A:two", kind: "preview", resourceId: "tab-2", ownerThreadId: "thread-A" },
    { id: "diff", kind: "diff" },
