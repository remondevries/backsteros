...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Composer context-window meter (circular indicator, bottom-left). On when
  // the provider reports live usage; stays hidden when no usage is available
  // (no invented numbers). Disable from Settings if you prefer it off.
