import { ENTITY_ICON_EMOJIS } from "@/lib/entity-icon-emojis";
import { isProjectIconKey, type ProjectIconKey } from "@/lib/project-icon";
...
export const DEFAULT_ENTITY_ICON_COLOR = ENTITY_ICON_COLOR_PRESETS[0];
...
export function entityIconsEqual(
  ...
  return serializeEntityIcon(parseEntityIcon(a)) === serializeEntityIcon(parseEntityIcon(b));
}
