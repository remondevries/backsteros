import { shouldHandleContentPreviewArrowScroll } from "@/lib/shortcuts/content-preview-scroll";
...
function listKeyboardNavDirection(
  key: string,
): "up" | "down" | null {
...
export function shouldHandleListKeyboardActivate(
  event: KeyboardEvent,
): boolean {
