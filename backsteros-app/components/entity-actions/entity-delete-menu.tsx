...
export function EntityDeleteMenu({
  ...
  const isMobileToolbarTrigger = triggerVariant === "mobile-circle-toolbar";
  const triggerClassName = isMobileToolbarTrigger
    ? "mobile-entity-actions-toolbar-trigger mobile-circle-toolbar-button"
    : "flex size-7 items-center justify-center rounded-md text-foreground/45 transition-colors hover:bg-white/[0.06] hover:text-foreground/75 disabled:opacity-50";
