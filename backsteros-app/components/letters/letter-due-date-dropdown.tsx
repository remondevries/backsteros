...
import { updateLetterDueDateAction } from "@/lib/mutations/letters";
import {
  updateLocalLetterDueDate,
...
type LetterDueDateDropdownProps = {
  letterId: string;
...
export function LetterDueDateDropdown({
  letterId,
  projectId,
  dueDate: initialDueDate,
  status = null,
  variant }: LetterDueDateDropdownProps) {
  ...
  const persist = useCallback(
    ...
    [initialDueDate, letterId, projectId, ymdValue],
  );
        ...
        renderTrigger={({ open, disabled, triggerId, onToggle }) => (
          ...
          >
            <TaskDueDateIcon
              ...
              className={
                hasDueDate ? "shrink-0 text-foreground/50" : "shrink-0 text-foreground/40"
              }
            />
