...
const TABLE_SPECS: TableSpec[] = [
  ...
  spec("contacts", ["id"]),
  spec("contact_relationships", ["id"]),
  spec("crm_relationship_labels", ["id"]),
  spec("crm_groups", ["id"]),
  spec("crm_group_members", ["id"]),
  spec("crm_activities", ["id"]),
  spec("projects", ["id"]),
  spec("project_updates", ["id"], "updated_at", { optional: true }),
  spec("habits", ["id"]),
