...
├── backsteros-development/ Agent console (projects / tasks / terminal)
...
- [orca](../orca) — inspiration clone ([stablyai/orca](https://github.com/stablyai/orca)); not part of BacksterOS
