...
import {
  OrganizationsHeader,
} from "../../../components/organizations-header";
...
export default function OrganizationsLayout() {
  const { collapsed, setCollapsed } =
    usePadSidePanelCollapsed("organizations");
    ...
    <View style={styles.split}>
      {collapsed ? (
        <PadSidePanelCollapsedRail
          ...
          accessibilityLabel="Show Organizations list"
        />
      ) : (
        <View style={styles.listPane}>
          <OrganizationsHeader onToggleCollapse={() => setCollapsed(true)} />
          <View style={styles.listBody}>
            <OrganizationsListPane autoSelectFirst />
          </View>
        </View>
      )}
      <PadContentFrame>
