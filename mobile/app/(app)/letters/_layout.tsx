...
import {
  LettersHeader,
} from "../../../components/letters-header";
...
export default function LettersLayout() {
  const { collapsed, setCollapsed } = usePadSidePanelCollapsed("letters");
    ...
    <View style={styles.split}>
      {collapsed ? (
        <PadSidePanelCollapsedRail
          ...
          accessibilityLabel="Show Letters list"
        />
      ) : (
        <View style={styles.listPane}>
          <LettersHeader onToggleCollapse={() => setCollapsed(true)} />
          <View style={styles.listBody}>
            <LettersListPane autoSelectFirst />
          </View>
        </View>
      )}
      <PadContentFrame>
