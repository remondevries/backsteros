...
export const PIERRE_FILE_ICON_SYMBOLS: Record<string, PierreSpriteSymbol> = {
  ...
  "file-tree-builtin-image": {
    "viewBox": "0 0 16 16",
    "body": "<path fill=\"currentColor\" d=\"M12.5 2A2.5 2.5 0 0 1 15 4.5v4.67l-4.05-3.54-4.08 4.08-3-2L1 10.6V4.5A2.5 2.5 0 0 1 3.5 2z\" opacity=\".3\"/>\n  <path fill=\"currentColor\" d=\"M15 10.5v1a2.5 2.5 0 0 1-2.5 2.5h-9a2.5 2.5 0 0 1-2.46-2.04L4 9l3 2 4-4zm-7-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0\"/>"
  },
  "file-tree-builtin-javascript": {
    "viewBox": "0 0 16 16",
...
export const PIERRE_BUILT_IN_FILE_EXTENSION_TOKENS: Record<string, string> = {
  "7z": "zip",
  "astro": "astro",
  "AUTHORS": "text",
  "avif": "image",
...
export const PIERRE_COMPLETE_EXTENSION_OVERRIDES: Record<string, string> = {
  "jsx": "react",
  "sass": "sass",
  "scss": "sass",
  "tsx": "react"
...
export const PIERRE_STANDARD_TIER_TOKENS = new Set<string>(["bash","c","cpp","css","database","default","font","git","go","html","image","javascript","json","markdown","mcp","python","ruby","rust","swift","table","text","typescript","zip"]);

export const PIERRE_T3_BY_FILE_NAME: Record<string, string> = {
